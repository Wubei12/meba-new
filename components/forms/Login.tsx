...
const alreadLoggedId = "alreadLogged-yes"
const FailedLoginId = "failedLogged-yes"
...
export default function Login() {
  ...
  return (
    <div className='relative flex items-center h-screen mx-auto overflow-x-hidden max-lg:justify-center'>
            <div className='absolute w-full h-full'>
                <div className='relative flex w-full h-full'>
                    <div className='absolute z-10 flex w-full h-full bg-black/50' />
            ...
            <div className="flex absolute items-center bg-white z-20 lg:right-0 rounded-xl w-full max-w-sm md:max-w-xl shadow-2xl md:mx-8 flex-1 flex-col justify-center md:py-[5rem] md:my-0 my-4 py-10">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <p className="mx-2 mt-4 text-center text-gray-500 dark:text-gray-400">
                ...
                <form onSubmit={handleSubmit} className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                  ...
                  />
                  <label className='block text-sm font-medium leading-8 text-gray-900 text-gray-900block'>
                    Password
                  </label>
                  ...
                  onChange={handleChange}
                  />
                   <div className='absolute transition duration-300 cursor-pointer right-4 bottom-2 active:scale-125' onClick={toggleShowPass}>
